...
export default function Login() {
    ...
    const handleEmailLogin = async (e) => {
        ...
        try {
            ...
            // 1. Check/Create Profile logic inside login to ensure consistency
            // Note: The previous logic had this inline, refactoring to a helper would be cleaner but keeping it simple here.
