...
export default function ProjectStatus() {
    ...
    const renderTabs = () => (
        <div className="flex items-center gap-2 mb-6">
            ...
            <button
                ...
                className={clsx("px-4 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2", activeTab === 'tasks' ? "bg-emerald-600 text-white" : "bg-gray-800 text-gray-400 hover:text-white")}
            >
    ...
    if (activeTab === 'tasks') return (
        <div className="h-full flex flex-col p-4">
            ...
            <div className="flex-1 overflow-hidden border border-gray-700/50 rounded-2xl">
                <TaskBoard />
            </div>
        </div>
    );
