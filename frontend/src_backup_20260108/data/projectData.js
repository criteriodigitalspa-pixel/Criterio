export const PROJECT_DATA = {
    ...
    urgent: [
        { id: 'u8', title: '🚀 Puesta en Marcha (Web)', date: '2025-12-27', desc: 'Despliegue Final a URL Pública.', details: 'Subida definitiva a Firebase Hosting y verificación en dispositivos móviles.' },
        { id: 'p1', title: 'WooCommerce Conexión', date: '2025-12-27', desc: 'Enlace Base Tienda.', details: 'Validación de credenciales API y test de conexión con el sitio web.' },
        { id: 'i8', title: 'WooCommerce Sync Stock', date: '2025-12-28', desc: 'Sincronización Bidireccional.', details: 'Actualizar precio y stock en la web cuando se procesa en el taller.' },
        { id: 'i9', title: 'Sales Copy AI', date: '2025-12-29', desc: 'IA de Ventas.', details: 'Mejorar descripciones de equipos reacondicionados para vender más rápido.' },
        { id: 'p4', title: 'Email Triggers', date: '2025-12-30', desc: 'Avisos Automáticos.', details: 'Correo "Listo para Retiro" y "Presupuesto Pendiente" disparados por cambio de estado.' }
    ],
    important: [
        { id: 'i3', title: 'Homologación Formularios', date: '2026-01-02', desc: 'Clonar preguntas antiguas.', details: 'Asegurar que no falte ningún dato del formulario antiguo (Google Forms) antes de apagarlo.' },
        ...
        { id: 'p8', title: 'Generador Presupuestos', date: '2026-01-04', desc: 'Cotizaciones PDF Formales.', details: 'Herramienta para enviar presupuestos profesionales a empresas y clientes.' },
        ...
        { id: 'i5', title: 'Edición Masiva', date: '2026-01-06', desc: 'Gestión por Lotes.', details: 'Herramientas para mover o asignar técnicos a 10+ equipos de una vez.' },
        { id: 'p6', title: 'Reporte Eficiencia', date: '2026-01-07', desc: 'KPIs del Taller.', details: 'Métricas de velocidad de reparación por técnico y cuellos de botella.' },
        { id: 'p5', title: 'Auditoría Visual', date: '2026-01-08', desc: 'Timeline de Cambios.', details: 'Interfaz gráfica para ver la historia de modificaciones de un ticket.' }
    ],
    vision: [
