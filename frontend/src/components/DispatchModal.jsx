        ...
        try {
            ...
            if (actionType === 'SOLD') {
                if (salesDocumentType === 'Factura' && !clientInfo.clientRut) {
                    toast.error("Para Factura, el RUT del cliente es obligatorio.", { id: toastId });
                    setSaving(false);
                    return;
                }
                ...
                updates.soldBy = user?.uid || 'unknown_user'; // Safe access
                updates.isSold = true;

                // Financial Calculations (SAFE NUMBER PARSING)
                ...
                const ramDelta = Number(financials.ramDelta) || 0;
                ...
                updates.financials = {
                    ...
                    salesDocumentType,
                    viaticoCost: Number(viaticoCost) || 0,
                    publicidadCost: Number(publicidadCost) || 0
                };
            }
            ...
            if (onUpdate) onUpdate({ ...ticket, ...updates });
            ...
            toast.error(`Error: ${error.code || error.message || 'Desconocido'}`, { id: toastId, duration: 5000 });
        } finally {
            setSaving(false);
        }
    };
