...
export default function TicketModal({ isOpen, onClose, checkTicket, onSave }) {
    const { gpus, screens, resolutions, vrams } = useHardware();
    ...
    useEffect(() => {
        if (checkTicket) {
            setFormData({
                ...checkTicket,
                screenSize: checkTicket.additionalInfo?.screenSize || '',
                screenType: checkTicket.additionalInfo?.screenType || '',
                gpuBrand: checkTicket.additionalInfo?.gpuBrand || '',
                gpuModel: checkTicket.additionalInfo?.gpuModel || '',
                gpuVram: checkTicket.additionalInfo?.vram || ''
            });
        } else {
            setFormData({
                customerName: '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const { screenSize, screenType, gpuBrand, gpuModel, gpuVram, ...rest } = formData;
        const finalData = {
            ...rest,
            additionalInfo: {
                ...(rest.additionalInfo || {}),
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="md:col-span-2 pt-4 border-t border-gray-100 mt-4">
                            <label className="block text-xs font-bold text-gray-400 mb-3 flex items-center gap-2 uppercase tracking-wide">
                                <Monitor className="w-4 h-4 text-blue-400" /> Pantalla y Gráficos (Opcional)
                            </label>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <select
                                        ...
                                        className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
                                    >
                                ...
                                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <select
                                        ...
                                        className="bg-gray-50 border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-700 focus:border-purple-500 focus:outline-none"
                                    >
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-700 focus:border-purple-500 focus:outline-none disabled:opacity-50"
                                        >
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-700 focus:border-purple-500 focus:outline-none"
                                    >
