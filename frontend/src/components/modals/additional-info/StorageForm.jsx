                    ...
                    <div className="space-y-2">
                        {ram.detalles.map((detalle, i) => (
                            <div key={i}>
                                ...
                                />
                                <datalist id={`ram-suggestions-${i}`}>
                                    <option value="4GB DDR3" />
                                    <option value="8GB DDR3" />
                    ...
                    <div className="space-y-2">
                        {disk.detalles.map((detalle, i) => (
                            <div key={i}>
                                ...
                                />
                                <datalist id={`disk-suggestions-${i}`}>
                                    <option value="120GB SSD" />
                                    <option value="240GB SSD" />
                                    <option value="480GB SSD" />
                                    <option value="500GB HDD" />
